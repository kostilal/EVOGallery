...
open class EVOGalleryImageScrollView: UIScrollView {
    ...
    fileprivate func initialize() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(EVOGalleryImageScrollView.changeOrientationNotification), name: Notification.Name.UIDeviceOrientationDidChange, object: nil)
    }
    ...
    open func display(image: UIImage) {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(EVOGalleryImageScrollView.doubleTapGestureRecognizer(_:)))
    ...
    @objc func doubleTapGestureRecognizer(_ gestureRecognizer: UIGestureRecognizer) {
        ...
        if zoomScale >= maximumZoomScale / 2.0 {
            ...
            let zoomRect = zoomRectForScale(EVOGalleryImageScrollView.kZoomInFactorFromMinWhenDoubleTap * minimumZoomScale, center: center)
...
extension EVOGalleryImageScrollView: UIScrollViewDelegate{
